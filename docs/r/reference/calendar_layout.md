...
implicit `ANNUAL` root), one rectangle per contiguous slice segment, x
normalized to `[0, 1]` (share of the covered year). Exposed so the
...
segment), `slice` (the full prefix path id), `rank` (0 for `ANNUAL`,
...
#>   timeframe  label  slice rank      xmin       xmax ymin ymax      share weight
#> 1    ANNUAL ANNUAL ANNUAL    0 0.0000000 1.00000000    2  2.9 1.00000000   8760
#> 2   QUARTER     Q1     Q1    1 0.0000000 0.24657534    1  1.9 0.24657534   2160
#> 3   QUARTER     Q2     Q2    1 0.2465753 0.49589041    1  1.9 0.24931507   2184
#> 4   QUARTER     Q3     Q3    1 0.4958904 0.74794521    1  1.9 0.25205479   2208
#> 5   QUARTER     Q4     Q4    1 0.7479452 1.00000000    1  1.9 0.25205479   2208
#> 6      HOUR    h00 Q1_h00    2 0.0000000 0.01027397    0  0.9 0.01027397     90
#>   order within
#> 1     1      1
#> 2     1      1
#> 3    25      2
