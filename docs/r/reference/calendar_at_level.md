...
Together with
[`calendar_recast()`](https://optimal2050.github.io/timescales/r/reference/calendar_recast.md)'s
...
calendar_at_level(cal, "QUARTER")   # 4 timeslices, shares summed over hours
...
calendar_at_level(cal, "ANNUAL")    # 1 timeslice covering the year
